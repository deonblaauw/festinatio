package org.festinatio.service;

//import org.droidplanner.R; //DEON
//import org.droidplanner.activities.FlightActivity; //DEON
...
import org.festinatio.MainActivity;
...
public class MAVLinkService extends Service implements MavLinkConnectionListener {
	...
	public void onCreate() {
		super.onCreate();
		//commErrMsgLocalStore = getResources().getString(R.string.MAVLinkError); //DEON
		...
		showNotification();
		aquireWakelock();
		//updateNotification(getResources().getString(R.string.connected)); //DEON
	}
	...
	private void showNotification() {
		//updateNotification(getResources().getString(R.string.disconnected)); //DEON
	}

	private void updateNotification(String text) {
		NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
				this).setSmallIcon(com.example.festinatio.R.drawable.ic_launcher)
		...
		NotificationManager mNotificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
		mNotificationManager.notify(StatusBarNotification, mBuilder.build());*/ // DEON
	}
